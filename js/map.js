...
// EU_UA_BOUNDS: Shared bounding box for Europe + Ukraine (combined flight data)
const EU_UA_BOUNDS = { north: 71, south: 35, west: -11, east: 45 };
const REGIONS = {
    ...
    'europe': { center: [54, 15], zoom: 4, title: 'EUROPE', bounds: EU_UA_BOUNDS }, // Shares flight data with Ukraine
    ...
    'ukraine': { center: [48.5, 35], zoom: 6, title: 'UKRAINE CONFLICT ZONE', bounds: EU_UA_BOUNDS }, // Shares flight data with Europe
